...
def sr_min(allocs, prices):
    ...
    rfr = 0.0  #hardcoded because as per assignment instruction: Assume 252 trading days in a year and a risk free return of 0.0 per day
    sf = 252.0 #hardcoded because as per assignment instruction: Assume 252 trading days in a year and a risk free return of 0.0 per day
